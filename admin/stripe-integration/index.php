...
if (!empty($_POST["token"])) {
    $dbs = new mysqli("localhost", "root", "", "payment"); 
    ...
    $transaction = $stripeResponse["balance_transaction"];
    $status = $stripeResponse["status"];
    $response = json_encode($stripeResponse);
    ...
    $quers = "INSERT INTO tbl_payment (email, item, amount, currency_code, txn_id, payment_status, payment_response) values ('$email','$item_number', '$amount', '$currency', '$transaction', '$status', '$response')";
    $queryf = $dbs->query($quers);
